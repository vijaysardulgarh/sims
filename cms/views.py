...
#     teacher = fields.Field(column_name="teacher", attribute="teacher", widget=widgets.IntegerWidget())
#     section = fields.Field(column_name="section", attribute="section", widget=widgets.IntegerWidget())
#     class_subject = fields.Field(column_name="class_subject", attribute="class_subject", widget=widgets.IntegerWidget())
...
#     def dehydrate_stream_name(self, obj):
#         return obj.section.stream.name if obj.section and obj.section.stream else ""

#     def dehydrate_medium_name(self, obj):
#         return obj.section.medium.name if obj.section and obj.section.medium else ""
...
#                     sec_class__name__iexact=class_name.strip(),
...
#                 raise ValueError(f"❌ Multiple sections found for '{class_name}-{section_name}'")

#         # --- ClassSubject ---
#         subject_name = row.get("Subject")
#         if class_name and subject_name:
#             try:
#                 # Filter by class name and subject name
#                 class_subject = ClassSubject.objects.filter(
#                     subject_class__name__iexact=class_name.strip(),
...
from import_export import resources, fields
from .models import TeacherSubjectAssignment, Staff, Section, ClassSubject
...
class ClassSubjectAdmin(ImportExportModelAdmin):
    ...
    list_filter = ("subject_class", "stream", "sub_stream", "is_optional", "has_lab", "is_shared")
